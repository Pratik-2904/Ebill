...
public class Project extends JFrame implements ActionListener {
    ...
    Project(String acc_type, String meter) {
        this.atype = acc_type;
        this.meter = meter;
